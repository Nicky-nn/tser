...
import {SinActividadesProps, SinProductoServicioProps} from "../../../sin/interfaces/sin.interface";
...
const ProductoHomologacion: FunctionComponent<Props> = (props) => {
    ...
    const {
        ...
        error: prodServError
    } = useQuery<SinProductoServicioProps[], Error>(['productosServicios', actividadEconomicaWatch],
        async () => {
            return await fetchSinProductoServicioPorActividad(getValues('actividadEconomica.codigoCaeb'))
        }, {
                                    ...
                                    <Controller
                                        ...
                                        render={({field}) => (
                                            <FormControl fullWidth component={'div'} error={
                                                Boolean(errors.sinProductoServicio)
                                            }>
                                                <MyInputLabel shrink>
                                                    Producto Homologado
                                                </MyInputLabel>
