...
export interface ClasificadorProductoProps {
  codigoProducto: string
  _id: string
  nombre: string | null
  icono: string | null
  precio: string | null
  items: ClasificadorProductoItemProps[]
  inventario: InventarioProps[]
  producto: ProductoVarianteProps[]
}

export interface ClasificadorProductoItemProps {
  nombre: string
  precio: string
  icono: string | null
}

export interface ProductoOrdenProps {
  id: string
  _id: string
  codigoProducto: string
