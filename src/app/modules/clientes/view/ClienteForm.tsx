                ...
                <Grid item lg={12} md={12} sm={12} xs={12} sx={{mt: 2}}>
                    {
                        tdiLoading ? <AlertLoading/> : (
                            <FormControl fullWidth error={Boolean(formik.errors.codigoTipoDocumentoIdentidad)}>
                                ...
                                <Select<SinTipoDocumentoIdentidadProps>
                                    ...
                                    value={
                                        tiposDocumentoIdentidad ? tiposDocumentoIdentidad.find(
                                            option =>
                                                option.codigoClasificador.toString() === genReplaceEmpty(formik.values.codigoTipoDocumentoIdentidad?.toString(), '')
                                        ) : null
                                    }
                                    onChange={(tipoDocumento: SingleValue<SinTipoDocumentoIdentidadProps>) => {
                                        formik.setFieldValue('codigoTipoDocumentoIdentidad',
                                ...
                                />
                                <FormHelperText>{formik.errors.codigoTipoDocumentoIdentidad}</FormHelperText>
                            </FormControl>
                        )
                    }
                </Grid>
