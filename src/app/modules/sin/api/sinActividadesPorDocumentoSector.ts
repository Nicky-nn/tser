...
import {SinActividadesPorDocumentoSector, SinActividadesProps} from "../interfaces/sin.interface";
...
export const fetchSinActividadesPorDocumentoSector = async (): Promise<SinActividadesProps[]> => {
