...
export const selectSucursal = (state: RootState): SucursalProps[] => state.clasificador.sucursal;
export const selectUnidadMedida = (state: RootState): SinUnidadMedidaProps[] => state.clasificador.unidadMedida;
